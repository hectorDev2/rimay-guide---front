...
const SACSAYHUAMAN_STOPS: TourStop[] = [
  stop({
    ...
    longitude: -71.9815,
    radiusMeters: 15,
    audioSrc: '/voices/female/parada_1_female.mp3',
    durationSeconds: 71,
  ...
  stop({
    ...
    longitude: -71.9820,
    radiusMeters: 20,
    audioSrc: '/voices/female/parada_2_female.mp3',
    durationSeconds: 93,
  ...
  stop({
    ...
    longitude: -71.9825,
    radiusMeters: 25,
    audioSrc: '/voices/female/parada_3_female.mp3',
    durationSeconds: 97,
  ...
  stop({
    ...
    longitude: -71.9830,
    radiusMeters: 20,
    audioSrc: '/voices/female/parada_4_female.mp3',
    durationSeconds: 97,
  ...
  stop({
    ...
    longitude: -71.9820,
    radiusMeters: 25,
    audioSrc: '/voices/female/parada_5_female.mp3',
    durationSeconds: 107,
  ...
  stop({
    ...
    longitude: -71.9805,
    radiusMeters: 20,
    audioSrc: '/voices/female/parada_6_female.mp3',
    durationSeconds: 116,
  ...
  stop({
    ...
    longitude: -71.9795,
    radiusMeters: 20,
    audioSrc: '/voices/female/parada_7_female.mp3',
    durationSeconds: 93,
  ...
  stop({
    ...
    longitude: -71.9790,
    radiusMeters: 15,
    audioSrc: '/voices/female/parada_8_female.mp3',
    durationSeconds: 80,
  ...
  stop({
    ...
    longitude: -71.9800,
    radiusMeters: 15,
    audioSrc: '/voices/female/parada_9_female.mp3',
    durationSeconds: 104,
